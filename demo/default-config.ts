// Default Tailwind v4 theme subset for the static demo.
// Provides the scale values the ScaleScrubber needs to cycle through.
...
export const defaultTailwindConfig = {
  ...
  borderRadius: Object.fromEntries([
    ['none', 'none'], ['sm', 'sm'], ['DEFAULT', 'DEFAULT'], ['md', 'md'],
    ['lg', 'lg'], ['xl', 'xl'], ['2xl', '2xl'], ['3xl', '3xl'], ['full', 'full'],
  ]),
  colors: {
